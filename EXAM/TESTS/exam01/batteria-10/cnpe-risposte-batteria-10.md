# CNPE Simulator - Batteria 10 - Risposte Guida
> Governance, Policy Engines e Audit Compliance
> Focus strumenti: Kyverno, OPA Gatekeeper, PSA/PSS, RBAC
...
4. Scrivi output finale in /course/1/b10-q1.txt.
...
2. Applica patch/manifests con kubectl/CLI specializzato del dominio.
3. Verifica con get/describe/logs/events e stato controller.
4. Scrivi output finale in /course/2/b10-q2.txt.
...
2. Applica patch/manifests con kubectl/CLI specializzato del dominio.
3. Verifica con get/describe/logs/events e stato controller.
4. Scrivi output finale in /course/3/b10-q3.txt.
...
2. Applica patch/manifests con kubectl/CLI specializzato del dominio.
3. Verifica con get/describe/logs/events e stato controller.
4. Scrivi output finale in /course/4/b10-q4.txt.
...
2. Applica patch/manifests con kubectl/CLI specializzato del dominio.
3. Verifica con get/describe/logs/events e stato controller.
4. Scrivi output finale in /course/5/b10-q5.txt.
...
2. Applica patch/manifests con kubectl/CLI specializzato del dominio.
3. Verifica con get/describe/logs/events e stato controller.
4. Scrivi output finale in /course/6/b10-q6.txt.
...
2. Applica patch/manifests con kubectl/CLI specializzato del dominio.
3. Verifica con get/describe/logs/events e stato controller.
4. Scrivi output finale in /course/7/b10-q7.txt.
...
2. Applica patch/manifests con kubectl/CLI specializzato del dominio.
3. Verifica con get/describe/logs/events e stato controller.
4. Scrivi output finale in /course/8/b10-q8.txt.
...
2. Applica patch/manifests con kubectl/CLI specializzato del dominio.
3. Verifica con get/describe/logs/events e stato controller.
4. Scrivi output finale in /course/9/b10-q9.txt.
...
2. Applica patch/manifests con kubectl/CLI specializzato del dominio.
3. Verifica con get/describe/logs/events e stato controller.
4. Scrivi output finale in /course/10/b10-q10.txt.
