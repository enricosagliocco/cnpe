...
for c in minikube kubectl helm git docker curl; do
...
- deploy.yaml
YAML
seed_git_repo_to_gitea "$COURSE_ROOT/1/repo-gitops" "cnpe-bilanciata-01-repo-gitops" "init"
  ...
  template:
    ...
    spec:
      ...
      - name: app
        image: nginx:1.25
YAML
seed_git_repo_to_gitea "$COURSE_ROOT/4/repo-flux" "cnpe-bilanciata-01-repo-flux" "init"
